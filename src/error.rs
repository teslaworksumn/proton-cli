...
impl error::Error for Error {
    fn description(&self) -> &str {
        match *self {
            ...
            Error::InvalidSequenceSection => "Invalid sequence section",
    ...
    fn cause(&self) -> Option<&error::Error> {
        match *self {
           ...
           Error::InvalidSequenceSection => None,
...
impl fmt::Display for Error {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match *self {
            ...
            Error::InvalidSequenceSection => write!(f,
                "Sequence section not found"),
